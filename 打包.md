...
#### 打包华为大数据平台
```shell
mvn -s /var/lib/jenkins/tools/hudson.tasks.Maven_MavenInstallation/Maven-3.6.2/conf/settings-huawei.xml -gs /var/lib/jenkins/tools/hudson.tasks.Maven_MavenInstallation/Maven-3.6.2/conf/settings-huawei.xml clean deploy source:jar -DskipTests -T2.0C -Denforcer.skip=true -Pinclude-graph -Pinclude-atlas -Pinclude-hive -Pinclude-hive1_1 -Pinclude-hive3 -Pinclude-media -Pinclude-sql-reporting -Pinclude-rules -Pinclude-accumulo -Ptargz -Pinclude-ranger -Pinclude-asn1 -Pinclude-snowflake
```
